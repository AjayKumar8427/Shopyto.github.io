<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="84271363a@gmail.com"><i class="fas fa-envelope"></i> 84271363a@gmail.com</a>
         <a href="https://www.google.com/"><i class="fas fa-map-marker-alt"></i> mumbai, india - 400104 </a>
      </div>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>Ajay Kumar</span> | all rights reserved!</div>
